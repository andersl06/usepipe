...
const URL_DESK = (import.meta.env['VITE_PIPE_DESK_URL'] as string | undefined) ?? 'http://localhost:3200';
    ...
    <>
      ...
      <section className="card" id="equipe">
        ...
        <p className="sub">
          ...
          escolhido e liga a conta do Google na primeira entrada. {numero(sinais.membros)} pessoa(s)
          com acesso e {numero(sinais.convites)} convite(s) criado(s).
        </p>
        <FormularioConvite />
      </section>
