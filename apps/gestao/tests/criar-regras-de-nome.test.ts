...
import { IMAGEM, conferir, nomeCurto, tipoRealDaImagem } from '../src/app/criar/regras-de-nome.ts';
import { RECADOS as RECADOS_ROTEADOR } from '../src/app/criar/roteador/regras.ts';
import { RECADOS as RECADOS_FLUXO } from '../src/app/criar/fluxo/regras.ts';
