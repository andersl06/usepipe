...
import { trocarDeConta } from '../app/portal/acoes';
import type { CascaDoPortal } from '../lib/portal';
    ...
    <header className="g-barra g-barra-sup pt-barra">
      ...
      <details className="g-menu pt-conta">
        ...
        <div className="g-painel pt-conta-menu">
          ...
          {outras.length > 0 ? (
            <form action={trocarDeConta} className="pt-contas">
              ...
              {outras.map((conta) => (
                <button key={conta.tenantId} type="submit" name="tenantId" value={conta.tenantId}>
