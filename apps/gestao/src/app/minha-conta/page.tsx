...
export const metadata: Metadata = {
  title: 'Minha conta · Pipe',
  description: 'Os dados da sua empresa no Pipe.',
};
...
export default async function PaginaMinhaConta({
  ...
  searchParams: Promise<{ erro?: string; campo?: string }>;
}) {
  const [eu, conta, parametros] = await Promise.all([exigirEu(), contaEmVigor(), searchParams]);
