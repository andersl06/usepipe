...
import { listarContatosDoFluxo } from '../../../../lib/contatos-do-fluxo';
import {
...
export default async function ListaContatosDoBot({ params }: { params: Promise<{ id: string }> }) {
                ...
                >
                  ...
                  <span className="ct-secao ct-secao-nome">
                    ...
                    <span className="ct-ultima-interacao">
                      ...
                      <span>{formatarUltimaInteracao(contato.ultimaConversa)}</span>
                    </span>
                  </span>
