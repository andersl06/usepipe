    ...
    <form ref={formulario} onSubmit={envioQuePreserva(enviar)} className="form-cadastro">
      <div className="form-linha">
        <label className="form-campo" style={{ flexBasis: '280px' }}>
          ...
          <Campo name="email" type="email" placeholder="ana@empresa.com.br" required disabled={enviando} />
        </label>
      ...
      {resultado.link ? (
        <label className="form-campo">
          <span className="sub">
            Envie este link à pessoa. Vale sete dias e uma vez só; convidar de novo invalida o anterior.
          </span>
...
export function FormularioManual() {
  ...
  return (
    <details className="g-grupo">
      <summary className="sub">Conectar sem o cadastro embutido, com token de usuário de sistema</summary>
      <form ref={formulario} onSubmit={envioQuePreserva(enviar)} className="form-cadastro">
        <div className="form-linha">
          <label className="form-campo">
        ...
        <label className="form-campo">
          <span className="sub">
            Token de usuário de sistema, com whatsapp_business_messaging e whatsapp_business_management
          </span>
