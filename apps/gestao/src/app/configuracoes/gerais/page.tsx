...
import { carregarGerais } from '../../../lib/configuracoes';
...
import { salvarEtiquetasDeEncerramento, salvarIdentidade, salvarPesquisa } from '../acoes';
...
export default async function PaginaConfiguracoesGerais() {
  const { identidade, pesquisa, outrasPesquisas, etiquetas } = await carregarGerais();
