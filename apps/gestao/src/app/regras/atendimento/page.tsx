import { carregarRegrasDeFila } from '../../../lib/cadastros';
...
import { alternarRegraFila } from '../acoes';
import { FormularioRegraFila } from './formulario';
...
export default async function PaginaRegrasDeAtendimento() {
  const { regras, filas, padroes } = await carregarRegrasDeFila();
