...
export const metadata: Metadata = {
  title: 'Criar roteador · Pipe',
  description: 'Reúna vários fluxos em um só contato inteligente.',
};
...
const URL_SABER_MAIS = process.env['NEXT_PUBLIC_PIPE_AJUDA_ROTEADOR_URL'] ?? '';

export default async function PaginaCriarRoteador({
  searchParams,
}: {
