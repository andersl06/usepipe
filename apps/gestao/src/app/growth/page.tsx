 ...
 */
export default function PaginaGrowth() {
  return (
    <div className="g-leitura">
      ...
      <section className="card">
        ...
        <p className="sub">
          ...
          não vira, ele não entra em nenhuma média de tempo: contar disparo como atendimento infla
          o volume e derruba o TMR sem que ninguém tenha atendido melhor.
        </p>
        <p className="note">
          Os sete estados definidos são: agendada, enviando, enviada, entregue, lida, falha e
          expirada. O relatório que vai ler isso é o de <Link href="/relatorios/atendimento">Atendimento</Link>,
          e ele precisa continuar mostrando a população descartada ao lado de cada média.
        </p>
      </section>
