...
|---|---|---|---|---|---|
| erro | error |  | none | Recomendado: error; alternativa: failure; evidência: 789 (256 backend + 533 front) | no |
| fluxo | flow |  | none | Recomendado: flow; alternativa: workflow; evidência: 583 (346 backend + 237 front) | no |
| canal | channel |  | none | Recomendado: channel; alternativa: medium; evidência: 550 (398 backend + 152 front) | no |
| conversa | conversation |  | none | Recomendado: conversation; alternativa: chat; evidência: 507 (368 backend + 139 front) | no |
| valor | value |  | none | Recomendado: value; alternativa: amount; evidência: 476 (115 backend + 361 front) | no |
| fila | queue | referencias-blip/portal/INDICE.md | none | Recomendado: queue; alternativa: line; evidência: 464 (295 backend + 169 front) | no |
...
| entrar | login |  | none | Recomendado: login; alternativa: sign-in; evidência: 128 (15 backend + 113 front) | no |
...
| leitura | read |  | none | Recomendado: read; alternativa: reading; evidência: 90 (10 backend + 80 front) | no |
| prioridade | priority |  | none | Recomendado: priority; alternativa: rank; evidência: 90 (66 backend + 24 front) | no |
| entrega | delivery |  | none | Recomendado: delivery; alternativa: dispatch; evidência: 87 (59 backend + 28 front) | no |
...
| varredura | sweep |  | none | Recomendado: sweep; alternativa: scan; evidência: 11 (10 backend + 1 front) | no |
| agregação | aggregation |  | none | Recomendado: aggregation; alternativa: rollup; evidência: 9 (8 backend + 1 front) | no |
| distribuição | distribution |  | none | Recomendado: distribution; alternativa: routing; evidência: 8 (2 backend + 6 front) | no |
| mensagem ativa | activeMessage | referencias-blip/portal/INDICE.md | none | Recomendado: activeMessage; alternativa: outbound message; evidência: 7 (4 backend + 3 front) | no |
| componente | component |  | none | Recomendado: component; alternativa: widget; evidência: 5 (4 backend + 1 front) | no |
| novidades | updates |  | none | Recomendado: updates; alternativa: news; evidência: 5 (0 backend + 5 front) | no |
| ações em massa | bulk-ticket | referencias-blip/portal/INDICE.md | none | Recomendado: bulk-ticket; alternativa: bulk actions; evidência: 3 (0 backend + 3 front) | no |
| construtor | builder | referencias-blip/portal/INDICE.md | none | Recomendado: builder; alternativa: editor; evidência: 2 (2 backend + 0 front) | no |
| métrica | metric |  | none | Recomendado: metric; alternativa: measure; evidência: 0 (0 backend + 0 front) | no |
| tempo-real | realtime |  | none | Recomendado: realtime; alternativa: real-time; evidência: 0 (0 backend + 0 front) | no |
| ticket | ticket | referencias-blip/portal/INDICE.md | none | Recomendado: ticket; alternativa: session; evidência: 0 (0 backend + 0 front) | no |
