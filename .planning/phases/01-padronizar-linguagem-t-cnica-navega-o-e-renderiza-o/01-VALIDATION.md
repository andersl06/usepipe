...
| 01-20-T1 | 20 | 15 | STD-10, STD-11 | Triage security/auth/crypto/webhook/integration comments (100% Sonnet review) | automated | `node --input-type=module -e "...parseCsv(STD/comments/{api,workers,ponte}.csv)..."` (see 01-20 Task 1 verify) | W0 tools per plan deps | ⬜ pending |
| 01-20-T2 | 20 | 15 | STD-10, STD-11 | Triage API flow engine and domain comments | automated | `node --input-type=module -e "...parseCsv(STD/comments/api.csv)..."` (see 01-20 Task 2 verify) | W0 tools per plan deps | ⬜ pending |
| 01-20-T3 | 20 | 15 | STD-10, STD-11 | Triage API controller comments | automated | `node --input-type=module -e "...parseCsv(STD/comments/api.csv)..."` (see 01-20 Task 3 verify) | W0 tools per plan deps | ⬜ pending |
| 01-20-T4 | 20 | 15 | STD-10, STD-11 | Triage remaining API, workers and ponte comments | automated | `node --input-type=module -e "...parseCsv(STD/comments/{api,workers,ponte}.csv)..."` (see 01-20 Task 4 verify) | W0 tools per plan deps | ⬜ pending |
| 01-20-T5 | 20 | 15 | STD-10, STD-11 | Apply, slice 2 gate, tag std-slice-2-end | automated | `bash tools/std/gate.sh slice-2 && git rev-parse -q --verify refs/tags/std-slice-2-end` | W0 tools per plan deps | ⬜ pending |
